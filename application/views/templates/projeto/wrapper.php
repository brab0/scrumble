...
<?php $this->load->view(TEMPLATE_PROJETO_PARTIALS . "main_header"); ?>
            </header>
            <!-- Left side column. contains the logo and sidebar -->
            <aside class="main-sidebar">
                <!-- sidebar: style can be found in sidebar.less -->
<?php $this->load->view(TEMPLATE_PROJETO_PARTIALS . "main_sidebar"); ?>
                <!-- /.sidebar -->
            </aside>
...
<?php $this->load->view(TEMPLATE_PROJETO_PARTIALS . "control_sidebar"); ?>
